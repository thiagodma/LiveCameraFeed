...
if __name__ == "__main__":
    ...
    while True:
        ...
        cv2.putText(img, 'Number of persons: {}'.format(num_persons) ,(0,50), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255,0,0), 2)
